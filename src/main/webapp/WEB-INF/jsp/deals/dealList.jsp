...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title><spring:message code="deals.pageTitle" /></title>
	...
	<body>
		...
		<h1><spring:message code="deals.pageTitle" /></h1>
		<div id="deals_IN"  style="margin:5px auto;"></div>
		<div id="deals_OUT"  style="margin:5px auto;"></div>
		<!--  table id="grid"></table -->
		<!-- div id="pager"></div-->
		
		<script type="text/javascript" src="${dealJsUrl}"></script>
