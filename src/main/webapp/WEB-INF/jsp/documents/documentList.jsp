...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title><spring:message code="documents.pageTitle" /></title>
	...
	<body>
		...
		<h1><spring:message code="documents.pageTitle" /></h1>
		<div id="grid_IN"  style="margin:5px auto;"></div>
		<div id="grid_OUT"  style="margin:5px auto;"></div>
		<!--  table id="grid"></table -->
		<!-- div id="pager"></div-->
		
		<script type="text/javascript" src="${docsJsUrl}"></script>
