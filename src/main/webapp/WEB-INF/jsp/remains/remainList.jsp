...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title><spring:message code="remains.pageTitle" /></title>
	...
	<body>
		...
		<h1><spring:message code="remains.pageTitle" /></h1>
		<div id="grid_local_sort_BGN"  style="margin:5px auto;"></div>
		<div id="grid_local_sort_END"  style="margin:5px auto;"></div>
		<!--  table id="grid"></table -->
		<!-- div id="pager"></div-->
		
		<script type="text/javascript" src="${rmnsJsUrl}"></script>
